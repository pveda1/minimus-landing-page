...
function HeroHeader({ onJoinWaitlist }: { onJoinWaitlist: () => void }) {
  ...
  return (
    <header 
      ...
      data-name="Header"
    >
    <div className="flex flex-col gap-[12px] items-center w-full mb-[30px] md:mb-[50px]">
      ...
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.4] min-w-full relative shrink-0 text-[#6f6f6f] text-[15px] text-center tracking-[-0.075px] w-[min-content]" style={{ fontVariationSettings: "'opsz' 14" }}>
            helping early stage cpg sellers discover their product market fit through data-driven local store placement. 
          </p>
    </div>
      <button 
...
import imgImage from "figma:asset/2242711475cf01ba32ef27340142848497975805.png";
import imgImage1 from "figma:asset/2fd8af6969e2ec502b509d553334e6f01173cc27.png";
import imgHeroData from "./assets/Inner screen 2.png";
import { supabase } from "./lib/supabase";
import './styles/globals.css';
...
function InnerScreen() {
  return (
    <div className="absolute inset-[3%] rounded-[12px] md:rounded-[16px]" data-name="Inner screen">
...
function Ipad() {
  return (
    <div
      aria-label="Visual chart illustrating retail store matches"
      className="absolute bg-black left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-[907px] aspect-[907/644] rounded-[18px] md:rounded-[24px]"
      data-name="Ipad"
    >
      <div className="overflow-hidden relative w-full h-full rounded-[inherit]">
        <InnerScreen />
      </div>
      <div
        aria-hidden="true"
        className="absolute inset-0 pointer-events-none rounded-[18px] md:rounded-[24px] border border-[rgba(255,255,255,0.5)] shadow-[0px_-2px_10px_0px_rgba(0,0,0,0.1)] md:shadow-[0px_-4px_20px_0px_rgba(0,0,0,0.1)]"
      />
    </div>
  );
}
...
function HeroHeader({ onJoinWaitlist }: { onJoinWaitlist: () => void }) {
  ...
  return (
    <header 
      // @ts-ignore
      ref={revealRef}
      className={`box-border content-stretch flex flex-col gap-[30px] md:gap-[50px] items-center max-w-[1500px] pb-[80px] md:pb-[120px] pt-[60px] md:pt-[80px] px-4 md:px-0 relative shrink-0 w-full transition-all duration-1000 ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
      }`}
      data-name="Header"
    >
      <h1 className="block font-['Crimson_Text:Regular',sans-serif] leading-[0.9] not-italic relative shrink-0 text-[56px] sm:text-[80px] md:text-[120px] lg:text-[140px] xl:text-[160px] text-black text-center tracking-[-0.0425em] w-full">
        minimus.
      </h1>
      <button 
        onClick={onJoinWaitlist}
      ...
      <h1 className="block font-['Crimson_Text:Regular',sans-serif] h-[50px] md:h-[80px] lg:h-[100px] leading-[0.9] not-italic relative shrink-0 text-[80px] sm:text-[100px] md:text-[120px] lg:text-[140px] xl:text-[160px] text-black text-center tracking-[-0.0425em] w-full whitespace-pre-wrap"> </h1>
      <div className="bg-[#8e9c78] h-[250px] sm:h-[300px] md:h-[362px] relative rounded-[20px] md:rounded-[30px] shrink-0 w-full" data-name="Hero image">
        <Ipad />
      </div>
    </header>
  );
...
function Navigation() {
  return (
    <div className="box-border content-stretch flex h-[80px] sm:h-[120px] items-center justify-between max-w-[1500px] pb-[40px] sm:pb-[80px] pt-[20px] px-0 relative shrink-0 w-full" data-name="Navigation">
      <div className="h-[60px] relative shrink-0 w-[62px]" data-name="Group 2 2">
        <img alt="minimus" className="absolute inset-0 w-full h-full object-cover pointer-events-none" src={imgGroup22} />
      </div>
    </div>
  );
}
...
function Navigation1() {
  return (
    <nav className="box-border content-stretch flex flex-col items-center p-0 relative shrink-0 w-full max-w-[1200px]" data-name="Navigation">
      <Navigation />
    </nav>
  );
}
...
function Text() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] md:gap-[50px] items-start pl-0 pr-0 md:pr-[400px] py-0 relative w-full">
          <h2 className="block font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#485c11] text-[12px] tracking-[-0.12px] w-full md:w-[575.566px]">
            What we give you
          </h2>
          <p className="font-['Crimson_Text:Regular',sans-serif] leading-[0.9] not-italic relative shrink-0 text-[32px] md:text-[50px] lg:text-[60px] text-black tracking-[-0.03em] w-full">
            {`great products deserve great placement. `}
          </p>
          <p
            className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#6f6f6f] text-[15px] tracking-[-0.075px] w-full"
            style={{ fontVariationSettings: "'opsz' 14" }}
          >
            minimus connects early-stage CPG sellers with local small businesses to sell their products in-store.
          </p>
...
function Text1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Text 1">
      <p className="font-['Crimson_Text:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[18px] text-black tracking-[-0.54px] w-full">
        {`Stop wasting time hunting for the right stores. `}
      </p>
      <div
        className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#6f6f6f] text-[15px] tracking-[-0.075px] w-full"
        style={{ fontVariationSettings: "'opsz' 14" }}
      >
        <p className="mb-0">
          {`small businesses carefully curate products to fit their brand, whether that's condiments to go with their baked bread or authentic Italian oils that complement their dinner service. `}
        </p>
        <p className="mb-0">&nbsp;</p>
        <p>minimus finds stores with the niche that matches your product, increasing your chances of getting on their shelves.</p>
      </div>
...
function Text3() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Text 3">
      <p className="font-['Crimson_Text:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[18px] text-black tracking-[-0.54px] w-full">
        Build your first retail footprint.
      </p>
      <div
        className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#6f6f6f] text-[15px] tracking-[-0.075px] w-full"
        style={{ fontVariationSettings: "'opsz' 14" }}
      >
        <p className="mb-0">
          Stores in our network have personally told us they prefer working with other small businesses and hosting local products.
        </p>
        <p className="mb-0">&nbsp;</p>
        <p>{`Get in stores that build confidence in your retail potential so you can scale effectively. `}</p>
      </div>
...
function HeroImage() {
  ...
  return (
    <div 
      // @ts-ignore
      ref={revealRef}
      className={`relative w-full rounded-[20px] md:rounded-[30px] overflow-hidden transition-all duration-1000 delay-200 ${
        isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
      }`}
      data-name="Hero Image"
    >
      <div className="w-full h-full">
        <img
          alt="Product Market Fit Analysis showing demographic and value proposition data"
          src={imgHeroImage}
          className="w-full h-full object-cover"
        />
      </div>
...
function Image() {
  return (
    <div
      className="relative w-full md:w-1/2 aspect-[540/633] rounded-[30px] overflow-hidden shrink-0"
      data-name="Image"
    >
      <img
        alt="A image of a concrete sphere, balanced between two other larger spheres"
        src={imgImage}
        className="w-full h-full object-cover"
      />
    </div>
...
function Quote() {
  return (
    <section aria-label="Quote from a user about the product Area" className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Quote">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] md:gap-[50px] items-start justify-center pl-0 md:pl-[50px] pr-0 py-[40px] md:py-0 relative size-full">
          <p className="font-['Crimson_Text:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[28px] md:text-[35px] lg:text-[40px] text-black tracking-[-0.04em] w-full">
            "I recently got to try minimus and it's been amazing! I've branched out into stores I didn't even know existed and I'm learning more about my customers every day."
          </p>
          <Name />
        </div>
      </div>
...
function TestimonialSection({ innerRef }: { innerRef?: React.RefObject<HTMLDivElement> }) {
  ...
  return (
    <div 
      ...
      className={`box-border content-stretch flex flex-col md:flex-row gap-[20px] h-auto md:h-[692px] items-stretch max-w-[1500px] pb-[80px] md:pb-[120px] pt-[80px] md:pt-0 px-0 relative shrink-0 w-full transition-all duration-1000 ${
        isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'
      }`}
      data-name="Testimonial section"
    >
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-t-[1px] border-solid top-0 left-0 right-0 pointer-events-none" />
      <Image />
      <Quote />
    </div>
  );
...
function Frame4() {
  return (
    <div className="content-stretch flex items-start justify-start relative shrink-0 w-full">
      <p className="font-['Crimson_Text:Regular',sans-serif] leading-[0.9] not-italic relative shrink-0 text-[40px] md:text-[50px] lg:text-[60px] text-black text-left tracking-[-0.03em] whitespace-normal md:whitespace-pre">
        match to success.
      </p>
    </div>
  );
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      <p className="font-['Crimson_Text:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[18px] text-black tracking-[-0.54px] w-full">Get Started</p>
      <p
        className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#6f6f6f] text-[15px] tracking-[-0.075px] w-full whitespace-normal"
        style={{ fontVariationSettings: "'opsz' 14" }}
      >
        {`Join our wait list to be notified when minimus is available for use. `}
      </p>
    </div>
  );
}
...
function Lockup() {
  return (
    <section aria-label="Step 1 of 3" className="basis-0 grow min-h-px min-w-[240px] max-w-[320px] relative shrink-0" data-name="Lockup 1">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[60px] items-start min-w-inherit pb-[20px] pl-0 pr-[30px] pt-[60px] relative w-full">
          <p
            className="font-['DM_Sans:Regular',sans-serif] font-normal leading-none relative shrink-0 text-[#929292] text-[80px] tracking-[-3.2px] w-full"
            style={{ fontVariationSettings: "'opsz' 14" }}
          >
            01
          </p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      ...
      <p
        ...
        style={{ fontVariationSettings: "'opsz' 14" }}
      >
        {`minimus is priced on a $3 per-match model, allowing our sellers to pay only as much as they need. `}
      </p>
    </div>
  );
}
...
function Lockup1() {
  return (
    <section aria-label="Step 2 of 3" className="basis-0 grow min-h-px min-w-[240px] max-w-[320px] relative shrink-0" data-name="Lockup 2">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[60px] items-start min-w-inherit pb-[20px] pl-0 pr-[30px] pt-[60px] relative w-full">
          <p
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      ...
      <p
        ...
        style={{ fontVariationSettings: "'opsz' 14" }}
      >
        {`Make informed decisions to exceed your product sales and marketing goals. `}
      </p>
    </div>
  );
}
...
function Lockup2() {
  return (
    <section aria-label="Step 3 of 3" className="basis-0 grow min-h-px min-w-[240px] max-w-[320px] relative shrink-0" data-name="Lockup 3">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <div className="min-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[60px] items-start min-w-inherit pb-[20px] pl-0 pr-[30px] pt-[60px] relative w-full">
          <p
...
function Component3Up() {
  return (
    <div className="w-full overflow-x-auto md:overflow-x-visible -mx-4 px-4 md:mx-0 md:px-0" data-name="3-up-wrapper">
      <div className="content-stretch flex gap-[20px] items-start justify-start md:justify-center relative shrink-0 min-w-max md:min-w-0 md:w-full" data-name="3-up">
        <Lockup />
        <Lockup1 />
        <Lockup2 />
      </div>
...
function ImageContainer() {
  return (
    <div
      ...
      className="relative w-full max-w-[1500px] aspect-[1120/620] rounded-[30px] overflow-hidden"
...
function TextBox({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  return (
    <div className="bg-[#d9d9d9] box-border content-stretch flex gap-[2px] items-center justify-center px-[22px] py-[14px] relative rounded-[10px] shrink-0 w-full max-w-[320px]" data-name="text box">
      <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none rounded-[10px]" />
      <input
        type="email"
        value={value}
...
function ButtonLinkout({ onClick, disabled }: { onClick: () => void; disabled: boolean }) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="bg-[#485c11] box-border content-stretch flex gap-[2px] items-center justify-center px-[22px] py-[14px] relative rounded-[1000px] shrink-0 w-full md:w-[111px] cursor-pointer hover:bg-[#5a7115] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      data-name="Button linkout"
    >
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[1.4] relative shrink-0 text-[14px] text-center text-nowrap text-white tracking-[-0.35px] whitespace-pre" style={{ fontVariationSettings: "'opsz' 14" }}>
        Confirm
...
function Frame({ email, setEmail, onSubmit }: { email: string; setEmail: (value: string) => void; onSubmit: () => void }) {
  return (
    <div className="content-stretch flex flex-col md:flex-row gap-[20px] md:gap-[40px] items-stretch md:items-start relative shrink-0 w-full max-w-[500px]">
      <TextBox value={email} onChange={setEmail} />
      <ButtonLinkout onClick={onSubmit} disabled={!email} />
    </div>
  );
...
function CenteredCta({ innerRef, email, setEmail, onSubmit }: { innerRef?: React.RefObject<HTMLElement>; email: string; setEmail: (value: string) => void; onSubmit: () => void }) {
  ...
  return (
    ...
    >
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[0.5px_0px_0px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[40px] items-center max-w-inherit px-4 md:px-[100px] lg:px-[200px] xl:px-[300px] py-[80px] md:py-[120px] relative w-full">
          <p className="font-['Crimson_Text:Regular',sans-serif] leading-[0.9] not-italic relative shrink-0 text-[40px] md:text-[50px] lg:text-[60px] text-black text-center tracking-[-0.03em] w-full">
            Join the wait list.
          </p>
          <p
            className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#6f6f6f] text-[15px] text-center tracking-[-0.075px] w-full"
            style={{ fontVariationSettings: "'opsz' 14" }}
          >
            Be the first to hear when minimus is ready to be used by sellers like you.
            <br />
            <strong>minimus is priced at $3 per per-match.</strong>
          </p>
          <Frame email={email} setEmail={setEmail} onSubmit={onSubmit} />
        </div>
      </div>
...
function Main({ benefitsRef, specsRef, howToRef, signupRef, email, setEmail, onSubmit }: { 
  ...
  return (
    <main className="box-border content-stretch flex flex-col items-start p-0 relative shrink-0 w-full max-w-[1200px]" data-name="Main" tabIndex={-1}>
      <BenefitsSection innerRef={benefitsRef} />
      <TestimonialSection innerRef={specsRef} />
      <HowItWorksSection innerRef={howToRef} />
      <HeroImage1 />
...
function Credits() {
  return (
    <div className="content-stretch flex flex-wrap gap-[20px] md:gap-[40px] items-end relative shrink-0 w-full" data-name="Credits">
      <Logo />
      <Text5 />
      <div className="flex flex-col font-['Roboto_Mono:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#485c11] text-[12px] text-nowrap tracking-[-0.12px]">
        <p className="leading-[1.4] whitespace-pre">All Rights Reserved</p>
...
function Footer({ onClick }: { onClick: (section: string) => void }) {
  return (
    <footer className="box-border content-stretch flex flex-col gap-[40px] md:gap-[80px] items-start justify-end max-w-[1200px] pb-[20px] pt-[40px] px-0 relative shrink-0 w-full" data-name="Footer">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      <Links onClick={onClick} />
      <Credits />
    </footer>
...
function NavItems1({ onClick }: { onClick: (section: string) => void }) {
  return (
    <div className="fixed backdrop-blur-[15px] backdrop-filter bg-[rgba(255,255,255,0.4)] box-border content-stretch flex font-['DM_Sans:Bold',sans-serif] font-bold gap-[16px] md:gap-[27px] items-center left-1/2 overflow-clip px-[16px] md:px-[24px] py-[12px] md:py-[20px] rounded-[100px] text-[12px] md:text-[14px] text-black text-center text-nowrap top-[12px] md:top-[16px] tracking-[-0.35px] -translate-x-1/2 z-50" data-name="Nav Items">
      <button 
        onClick={() => onClick('benefits')}
        aria-label="Jump to product benefits section" 
        className="[white-space-collapse:collapse] block cursor-pointer leading-[0] relative shrink-0 hover:text-[#485c11] transition-colors" 
      ...
      <button 
        ...
        style={{ fontVariationSettings: "'opsz' 14" }}
      >
        <p className="leading-[1.4] text-nowrap whitespace-pre hidden sm:inline">How it Works</p>
        <p className="leading-[1.4] text-nowrap whitespace-pre sm:hidden">How-To</p>
      </button>
      <button 
        onClick={() => onClick('signup')}
        aria-label="Jump to contact us section" 
...
export default function Desktop() {
  ...
  return (
    <div className="bg-white relative w-full min-h-screen" data-name="Desktop">
      <div className="w-full">
        <div className="box-border content-stretch flex flex-col items-center px-4 sm:px-8 md:px-12 lg:px-20 xl:px-[120px] py-0 relative w-full">
          <Navigation1 />
          <HeroHeader onJoinWaitlist={() => scrollToSection('signup')} />
          <Main 
            benefitsRef={benefitsRef}
